  ...
  <div class="card-body">
    ...
    <tr>
       ...
       <td class="text-centre">
          <a href="{{ route('ProductController.edit_existing', [$value['id']]) }}" class='btn btn-success' data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i></a>
          ...
          <form method="post" id="delete-form-{{$value['id']}}" action="{{route('ProductController.destroy_existing',[$value['id']])}}" 
